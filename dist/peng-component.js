...
var Component = function () {
  ...
  var secTableObserver = function secTableObserver(_ref2) {
    var treeStyles = _ref2.treeStyles,
        pars = _ref2.pars;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                ...
                showDom = getData.map(function (arr) {
  ...
  var treeTable = function treeTable(args) {
    return __async( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
      var data, next, beforeSelect, pars, ifselect, mask, treeComponent, treeDom, treeStyles, btns;
  ...
  var selectBeforeFunc$2 = function selectBeforeFunc$2(args) {
    ...
    addArrProp$3(contents).forEach(function (content) {
      beforeSelect.forEach(function (select) {
        var name = content.querySelector('.' + styles$10.name);
        if (name.innerText === select) {
          content.click();
        }
      });
  ...
  var eventProxy$2 = function eventProxy$2(args) {
    ...
    var domAddEvent = args.domAddEvent || document.querySelector('.' + styles$10['component-mask']);
    if (event === 'click') {
      var handleAllEvent = function handleAllEvent(e) {
        // empty
        ...
        if (isEmptyDom) {
          var inputs = isEmptyDom.parentElement.parentElement.querySelectorAll('.' + styles$10['tb-container'] + ' .' + styles$10.select);
          inputs.forEach(function (input) {
            if (input.parentElement.style.display !== 'none') {
      ...
      var _handleAllEvent4 = function _handleAllEvent4(e) {
        ...
        if (isSelectAllDom) {
          var inputs = isSelectAllDom.parentElement.parentElement.parentElement.querySelectorAll('.' + styles$10['tb-container'] + ' .' + styles$10.select);
          inputs.forEach(function (input) {
            if (input.parentElement.style.display !== 'none') {
              input.checked = e.target.checked;
              input.dataset.checked = e.target.checked;
        ...
        if (isSelectReverseDom) {
          var _inputs = isSelectReverseDom.parentElement.parentElement.parentElement.querySelectorAll('.' + styles$10['tb-container'] + ' .' + styles$10.select);
        ...
        addEvent$1({
          ...
          func: function func(e) {
            return e.path.filter(function (_e) {
              return _e.className === styles$10.tb;
            })[0].remove();
          }
        });
      ...
      return regeneratorRuntime.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 11:
              _context9.next = 13;
              return putDataToSecTable$1(data);

            case 13:
              btns = mask.querySelectorAll('.' + styles$10['component-table'] + ' button');
  ...
  var thrTableObserver$2 = function thrTableObserver$2(_ref3) {
    ...
    var observer = new MutationObserver(function () {
      ...
      addArrProp$4(document.querySelectorAll('.' + treeStyles.tree + ' .' + treeStyles.active)).forEach(function (dom) {
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              document.body.appendChild(mask);
              // await sleep(300);
              btns = mask.querySelectorAll('.' + styles$11.tree + ' button');
            ...
            case 16:
              _context10.next = 18;
              return thrTableObserver$2({ selectModel: selectModel, treeStyles: treeStyles });
  ...
  var thrTableObserver$3 = function thrTableObserver$3(_ref4) {
  ...
  var tree$2 = function tree$2(args) {
    return __async( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
      var data, next, beforeSelect, selectModel, ifselect, mask, treeDom, treeStyles, btns;
