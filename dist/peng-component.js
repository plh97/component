...
var Component = function () {
  ...
  var domFunc$1 = function domFunc$1(e) {
    var dom = e.dom,
        style = e.style;
  ...
  var sleep$1 = function sleep$1(ms) {
      ...
      var handleAllEvent = function handleAllEvent(e) {
        ...
        if (isSelectAll) {
          if (isSelectAll.classList.contains(styles$9.allSelect)) {
            ...
            addArrProp$1(domAddEvent.querySelectorAll('#tree-container > ol > li.' + styles$9.allSelect + ' #checkbox')).forEach(function (dom) {
              return dom.click();
            });
            addArrProp$1(domAddEvent.querySelectorAll('#tree-container > ol > li.' + styles$9.halfSelect + ' #checkbox')).forEach(function (dom) {
              dom.click();dom.click();
            });
          } else {
            // add all
            isSelectAll.classList.add(styles$9.allSelect);
            addArrProp$1(domAddEvent.querySelectorAll('#tree-container > ol > li:not(.' + styles$9.allSelect + ') #checkbox')).forEach(function (dom) {
              return dom.click();
            });
          }
        }
          ...
          if (isListInPath) {
            ...
            if (_isIdInPath) {
              ...
              if (isAllSelect === styles$9.allSelect) {
                // remove all
                addArrProp$1(container.children).forEach(function (ddom) {
        ...
        if (isIdInPath && !isIdInPath.querySelector('.icon-unfold')) {
          if (selectModel === 'radio') {
            addArrProp$1(domAddEvent.querySelectorAll('.' + styles$9.active)).forEach(function (activeDom) {
        ...
        // empty ，暴力清除所有
        var isEmptyDom = isIdInPathFunc$1({
          path: e.path,
          id: 'empty'
        });
        if (isEmptyDom) {
          addArrProp$1(domAddEvent.querySelectorAll('#tree-container .' + styles$9.active)).forEach(function (dom) {
            dom.classList.remove(styles$9.active);
          });
          addArrProp$1(domAddEvent.querySelectorAll('#tree-container .' + styles$9.allSelect)).forEach(function (dom) {
            dom.classList.remove(styles$9.allSelect);
          });
          addArrProp$1(domAddEvent.querySelectorAll('#tree-container .' + styles$9.halfSelect)).forEach(function (dom) {
          ...
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              data.forEach(function (row, i) {
                ...
                addArrProp$2(tableHead).forEach(function (dom) {
  ...
  var thrTableObserver = function thrTableObserver() {
    ...
    var observer = new MutationObserver(function () {
      ...
      addArrProp$2(secTableContainer.querySelectorAll('input:checked')).forEach(function (dom) {
  ...
  var eventProxy$2 = function eventProxy$2(args) {
    ...
    if (event === 'click') {
      var handleAllEvent = function handleAllEvent(e) {
        ...
        // 是否弹出表格
        var isTableContainer = isIdInPathFunc$2({
          path: path,
          id: 'thr-table'
        });
        var isShow = isIdInPathFunc$2({
          path: path,
          id: 'show'
        });
        if (isTableContainer) {
  ...
  var thrTableObserver$1 = function thrTableObserver$1(_ref4) {
    var treeStyles = _ref4.treeStyles;
    ...
    var observer = new MutationObserver(function () {
      ...
      addArrProp$3(document.querySelectorAll('.' + treeStyles.tree + ' .' + treeStyles.active)).forEach(function (dom) {
  ...
  var selectBeforeFunc$2 = function selectBeforeFunc$2(args) {
    ...
    var contents = document.querySelectorAll('#sec-table-tb-container >div');
    addArrProp$4(contents).forEach(function (content) {
      beforeSelect.forEach(function (select) {
  ...
  var putDataToSecTable$1 = function putDataToSecTable$1(_ref5) {
    var data = _ref5.data,
        tableHead = _ref5.tableHead;
          ...
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              data.forEach(function (row, i) {
                ...
                addArrProp$4(tableHead).forEach(function (dom) {
                  var id = dom.dataset.field;
  ...
  var eventProxy$3 = function eventProxy$3(args) {
    ...
    if (event === 'click') {
      ...
      var _handleAllEvent5 = function _handleAllEvent5(e) {
        var searchValue = e.target.value.replace(/([.?*+^$[\]\\(){}|-])/g, '\\$1');
        var allList = document.querySelector('#sec-table-tb-container').children;
        var filterList = addArrProp$4(allList).filter(function (list) {
        ...
        addArrProp$4(allList).forEach(function (dom) {
          return dom.style.display = 'none';
        });
        addArrProp$4(filterList).forEach(function (dom) {
  ...
  var thrTableObserver$3 = function thrTableObserver$3(_ref6) {
    ...
    var observer = new MutationObserver(function () {
      document.querySelector('#thr-table-tb-container').innerHTML = '';
      addArrProp$5(document.querySelectorAll('.' + treeStyles.tree + ' .' + treeStyles.active)).forEach(function (dom) {
        var jsonData = JSON.parse(dom.dataset.json);
        var div = document.createElement('label');
  ...
  var eventProxy$5 = function eventProxy$5(args) {
    ...
    if (event === 'click') {
      var handleAllEvent = function handleAllEvent(e) {
        ...
        // 是否弹出表格
        var isTableContainer = isIdInPathFunc$4({
          path: path,
          id: 'thr-table'
        });
        var isShow = isIdInPathFunc$4({
          path: path,
          id: 'show'
        });
        if (isTableContainer) {
  ...
  var thrTableObserver$4 = function thrTableObserver$4(_ref7) {
    var treeStyles = _ref7.treeStyles;
