      ...
      openList.forEach(dom => {
        ...
        if (isListInPath) {
          ...
          if (isIdInPath) {
            ...
            // });
            console.log(addArrProp$3(container.children).filter(ddom => ddom.id === 'tree-list-ol'));
            addArrProp$3(container.children).forEach(dddom => {
              if (dddom.id === 'tree-list-ol') {
                console.log(dddom);
                dddom.parentElement.className = styles$9.active;
              }
            });
