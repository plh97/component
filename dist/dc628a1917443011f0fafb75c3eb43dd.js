...
},{"buffer":16,"base64-js":41,"ieee754":42,"isarray":43}],14:[function(require,module,exports) {
var global = (1,eval)("this");
...
},{"./flag":24}],47:[function(require,module,exports) {
var global = (1,eval)("this");
...
},{"./flag":24,"type-detect":47,"assertion-error":40}],37:[function(require,module,exports) {
var config = require('../config');
...
},{"../config":8}],22:[function(require,module,exports) {
/*!
...
},{"./flag":24,"./isProxyEnabled":37,"./transferFlags":22,"../../chai":7}],38:[function(require,module,exports) {
/*!
...
},{"../config":8,"./getProperties":38,"./getEnumerableProperties":39,"get-func-name":48}],34:[function(require,module,exports) {
/*!
...
},{"./inspect":20,"../config":8}],21:[function(require,module,exports) {
/*!
...
},{"./flag":24,"./getActual":34,"./inspect":20,"./objDisplay":23}],25:[function(require,module,exports) {
/*!
...
},{"./transferFlags":22,"../../chai":7}],35:[function(require,module,exports) {
var config = require('../config');
...
},{"../config":8}],30:[function(require,module,exports) {
var config = require('../config');
var flag = require('./flag');
var getProperties = require('./getProperties');
var isProxyEnabled = require('./isProxyEnabled');
...
},{"./flag":24,"./isProxyEnabled":37,"../config":8,"./getProperties":38}],26:[function(require,module,exports) {
/*!
...
},{"./addLengthGuard":35,"./flag":24,"./proxify":30,"./transferFlags":22,"../../chai":7}],27:[function(require,module,exports) {
/*!
...
},{"./addLengthGuard":35,"./flag":24,"./proxify":30,"./transferFlags":22,"../../chai":7}],28:[function(require,module,exports) {
/*!
...
},{"./inspect":20}],29:[function(require,module,exports) {
/*!
...
},{"./flag":24,"./isProxyEnabled":37,"./transferFlags":22,"../../chai":7}],31:[function(require,module,exports) {
/*!
...
},{"./addLengthGuard":35,"./flag":24,"./proxify":30,"./transferFlags":22,"../../chai":7}],33:[function(require,module,exports) {
/*!
...
},{"./getOwnEnumerablePropertySymbols":31}],36:[function(require,module,exports) {
/*!
 * Chai - isNaN utility
...
},{"type-detect":47}],15:[function(require,module,exports) {
/*!
 * chai
...
},{"./test":17,"./expectTypes":18,"./addProperty":19,"./inspect":20,"./getMessage":21,"./transferFlags":22,"./objDisplay":23,"./flag":24,"./overwriteChainableMethod":25,"./overwriteMethod":26,"./addMethod":27,"./compareByInspect":28,"./overwriteProperty":29,"./proxify":30,"./getOwnEnumerablePropertySymbols":31,"./addChainableMethod":32,"./getOwnEnumerableProperties":33,"./getActual":34,"./addLengthGuard":35,"./isNaN":36,"./isProxyEnabled":37,"pathval":44,"check-error":45,"deep-eql":46,"type-detect":47,"get-func-name":48}],7:[function(require,module,exports) {
/*!
 * chai
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"./chai/config":8,"./chai/assertion":9,"./chai/interface/expect":10,"./chai/interface/assert":11,"./chai/core/assertions":12,"./chai/interface/should":13,"./chai/utils":15,"assertion-error":40}],6:[function(require,module,exports) {
module.exports = require('./lib/chai');

},{"./lib/chai":7}],3:[function(require,module,exports) {
// // import {
// //     pc,
// //     mobile
// // } from "peng-component";
  ...
  btn.addEventListener('click', function (e) {
    if (e.target.innerText == "treeTable") {
      treeTable({
        ...
        callback: function callback() {
          ...
          doms = doms.map(function (dom) {
            return dom.parentElement.querySelector('.name').textContent;
          });
          doms = doms.join('，');
          console.log(doms);
        }
      ...
      tree({
        // select_model: "checkbox",
        select_model: "radio",
        data: [{ id: "05", name: "法塞特家族酒庄仓库", pId: "", sid: 527, type: "" }, { id: "0501", name: "法塞特家族酒庄正品仓库", pId: "05", sid: 528, type: "正品" }, { id: "0502", name: "法塞特家族酒庄业务用酒仓库", pId: "05", sid: 529, type: "赠品" }, { id: "0503", name: "法塞特家族酒庄品鉴酒仓库", pId: "05", sid: 530, type: "试用装" }, { id: "0504", name: "法塞特家族酒庄物料仓库", pId: "05", sid: 531, type: "物料" }, { id: "0505", name: "法塞特家族酒庄配件仓库", pId: "05", sid: 532, type: "配件" }, { id: "0506", name: "法塞特家族酒庄包材仓库", pId: "05", sid: 533, type: "包材" }, { id: "0507", name: "上海酒庄门店正品库", pId: "05", sid: 614, type: "正品" }, { id: "0508", name: "上海酒庄门店业务用酒仓", pId: "05", sid: 615, type: "正品" }, { id: "0509", name: "上海酒庄门店品鉴酒仓", pId: "05", sid: 616, type: "正品" }, { id: "0510", name: "上海酒庄门店厨房用品仓", pId: "05", sid: 617, type: "正品" }, { id: "0511", name: "上海酒庄门店样酒仓", pId: "05", sid: 618, type: "正品" }, { id: "0512", name: "上海代保管仓", pId: "05", sid: 619, type: "正品" }],
        callback: function callback() {
          var doms = document.querySelectorAll('.component-tree .active');
          doms = addArrProp(doms);
          doms = doms.map(function (dom) {
            return dom.parentElement.querySelector('.text-container').textContent;
          });
          doms = doms.join('，');
          console.log(doms);
        }
      ...
      table({
        select_model: "checkbox",
        // select_model:"radio",
        data: [{ "id": "01d167cc9e864b038a3b9b26737d7e2d", "parent_ids": "0", "name": "111", "sort": 30, "code": "001001014013", "type": "4", "grade": "1", "USEABLE": "1", "del_flag": "0", "corp_code": "001001014", "corp_name": "法塞特酒业（上海）", "dept_id": "c7f76ff996244d08907911cba86597fc", "dept_code": "001001014", "dept_name": "法塞特酒业（上海）", "edu_user_id": "11521", "edu_user_name": "111" }, { "id": "32f08cdc623f41f99c614fe1b88c1c60", "parent_ids": "0", "name": "法塞特银川商贸有限公司", "sort": 30, "area_id": "76401", "code": "001001014012", "type": "5", "grade": "1", "address": "", "zip_code": "", "master": "", "phone": "", "fax": "", "email": "", "USEABLE": "1", "PRIMARY_PERSON": "", "DEPUTY_PERSON": "", "update_by": "30900", "update_date": 1514874616000, "remarks": "", "del_flag": "0", "corp_code": "001001014", "corp_name": "法塞特酒业（上海）", "dept_id": "c7f76ff996244d08907911cba86597fc", "dept_code": "001001014", "dept_name": "法塞特酒业（上海）", "edu_user_id": "11406", "edu_user_name": "银川品牌店" }, { "id": "42bfc2195d944b0ab79905991475d373", "parent_ids": "0", "name": "法塞特（浙江）供应链管理有限公司", "sort": 30, "code": "001001014005", "type": "4", "grade": "1", "USEABLE": "1", "del_flag": "0", "corp_code": "001001014", "corp_name": "法塞特酒业（上海）", "dept_id": "c7f76ff996244d08907911cba86597fc", "dept_code": "001001014", "dept_name": "法塞特酒业（上海）", "edu_user_id": "10445", "edu_user_name": "法塞特（浙江）供应链管理有限公司" }, { "id": "90a1b87797e94758bfdc91ec88fdf30c", "parent_ids": "0", "name": "法塞特（福建）供应链管理有限公司", "sort": 30, "code": "001001014005001", "type": "4", "grade": "1", "USEABLE": "1", "del_flag": "0", "corp_code": "001001014005", "corp_name": "法塞特（浙江）供应链管理有限公司", "dept_id": "e0e9b3f94f264c8bb979618f44b2e3cf", "dept_code": "001001014005", "dept_name": "法塞特（浙江）供应链管理有限公司", "edu_user_id": "10446", "edu_user_name": "法塞特（福建）供应链管理有限公司" }, { "id": "ff808081600fcb5f016010b0a87e00d2", "parent_ids": "0", "name": "宁夏圣路易.丁酒庄销售有限公司", "sort": 30, "area_id": "76401", "code": "001001014011", "type": "1", "grade": "1", "address": "", "zip_code": "", "master": "", "phone": "", "fax": "", "email": "", "USEABLE": "1", "PRIMARY_PERSON": "", "DEPUTY_PERSON": "", "create_by": "30158", "create_date": 1512108501000, "update_by": "30155", "update_date": 1514869647000, "remarks": "", "del_flag": "0", "corp_code": "001001014", "corp_name": "法塞特酒业（上海）", "dept_id": "c7f76ff996244d08907911cba86597fc", "dept_code": "001001014", "dept_name": "法塞特酒业（上海）", "edu_user_id": "", "edu_user_name": "圣路易&middot;丁酒庄销售有限公司" }, { "id": "ff8080816010d06e0160151416870111", "parent_ids": "0", "name": "宁夏一带一路供应链股份有限公司", "sort": 30, "area_id": "76401", "code": "001001014012", "type": "1", "grade": "1", "address": "", "zip_code": "", "master": "", "phone": "", "fax": "", "email": "", "USEABLE": "1", "PRIMARY_PERSON": "", "DEPUTY_PERSON": "", "create_by": "30158", "create_date": 1512182126000, "update_by": "30158", "update_date": 1512182126000, "remarks": "", "del_flag": "0", "corp_code": "001001014", "corp_name": "法塞特酒业（上海）", "dept_id": "c7f76ff996244d08907911cba86597fc", "dept_code": "001001014", "dept_name": "法塞特酒业（上海）", "edu_user_id": "", "edu_user_name": "宁夏一带一路供应链股份有限公司" }, { "id": "ff8080816082dae40160960dd02e0451", "parent_ids": "0", "name": "宁夏圣路易.丁葡萄酒庄（有限公司）", "sort": 30, "area_id": "76401", "code": "", "type": "2", "grade": "1", "address": "", "zip_code": "", "master": "", "phone": "", "fax": "", "email": "", "USEABLE": "1", "PRIMARY_PERSON": "", "DEPUTY_PERSON": "", "create_by": "30158", "create_date": 1514345975000, "update_by": "30158", "update_date": 1514345975000, "remarks": "", "del_flag": "0", "corp_code": "001001014", "corp_name": "法塞特酒业（上海）", "dept_id": "c7f76ff996244d08907911cba86597fc", "dept_code": "001001014", "dept_name": "法塞特酒业（上海）", "edu_user_id": "", "edu_user_name": "宁夏圣路易.丁葡萄酒庄（有限公司）" }, { "id": "ff808081609b096a01609b3e493c0033", "parent_ids": "0", "name": "顺丰快递", "sort": 30, "area_id": "11101", "code": "", "type": "6", "grade": "1", "address": "", "zip_code": "", "master": "", "phone": "", "fax": "", "email": "", "USEABLE": "1", "PRIMARY_PERSON": "", "DEPUTY_PERSON": "", "create_by": "30150", "create_date": 1514433038000, "update_by": "30150", "update_date": 1514433038000, "remarks": "", "del_flag": "0", "corp_code": "001001014", "corp_name": "法塞特酒业（上海）", "dept_id": "c7f76ff996244d08907911cba86597fc", "dept_code": "001001014", "dept_name": "法塞特酒业（上海）", "edu_user_id": "", "edu_user_name": "顺丰快递" }],
        callback: function callback() {
          var doms = document.querySelectorAll('.thr-table .tb-container input');
          doms = addArrProp(doms);
          doms = doms.map(function (dom) {
...
describe('变成大写字母+！', function () {
  it('["tori_spelling", "tori amos"] 有空格 "tori amos"', function () {
    expect(last(['jumpkick', 'roundhouse', 'uppercut'])).to.be.equal("uppercut");
  });
});
},{"../src/utils/functional.js":5,"chai":6}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent) {
  var ws = new WebSocket('ws://localhost:50798/');
